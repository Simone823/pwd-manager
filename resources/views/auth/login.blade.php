                        ...
                        <div class="card-body py-4">
                            <form method="POST" action="{{ route('login') }}">
                                ...
                                <div class="form-floating mb-3">
                                    <input type="text" class="form-control input-violet shadow-sm @error('username') is-invalid @enderror" id="username" name="username" value="{{old('username', $demoUser->username)}}" placeholder="Nome Utente" required autocomplete="username">
                                ...
                                <div class="form-floating mb-4">
                                    <input type="password" class="form-control input-violet shadow-sm @error('password') is-invalid @enderror" id="password" name="password" placeholder="Password" value="{{$demoUser->passwordDemoUser}}" required autocomplete="current-password">
