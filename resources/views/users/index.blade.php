                                ...
                                @foreach ($users as $user)    
                                    <tr>
                                        <th class="d-flex gap-2">
                                            {{-- btn show --}}
                                            <a href="{{route('users.show', $user->id)}}" class="btn btn-orange shadow">
                                                <i class="fa-sharp fa-solid fa-eye"></i>
                                            </a>

                                            {{-- btn edit --}}
                                            <a href="{{route('users.edit', $user->id)}}" class="btn btn-orange shadow @if($user->username == 'admin') disabled @endif">
